...
The plan is to have
- Ability to import ONE strava athlete
- Ability to import all the Ride activities of that athlete
- Ability to keep updating the data periodically
- Provide some basic visualizations of the data (e.g., total distance per month, average speed, calories per month)
  - Use Metabase for this
- Leverage Djando Admin to be able to view/edit the data
